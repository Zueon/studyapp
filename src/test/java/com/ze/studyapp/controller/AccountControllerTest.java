...
class AccountControllerTest {
    ...
    void signUpSubmit() throws Exception {
        mockMvc.perform(post("/sign-up")
                        .param("nickname", "nickname123")
                        .param("email", "email123@email.com")
                        .param("password", "1232344!@#$")
                        .with(csrf()))
                .andDo(print())
                .andExpect(status().is3xxRedirection())
                .andExpect(view().name("redirect:/"))
                .andExpect(authenticated().withUsername("nickname123"));
        assertTrue(accountRepository.existsByEmail("email123@email.com"));
        Account account = accountRepository.findByEmail("email123@email.com");
        assertNotEquals(account.getPassword(), "1232344!@#$");
